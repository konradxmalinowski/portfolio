        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">Poland <span role="img" aria-label="Polish flag">🇵🇱</span></p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <div className="min-h-[72px]" role="status" aria-live="polite" aria-atomic="true">
                {submitStatus === 'success' && (
                  ...
                  >
                    <svg className="w-6 h-6 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                ...
                {submitStatus === 'error' && (
                  ...
                  >
                    <svg className="w-6 h-6 text-red-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                {submitStatus === 'ratelimit' && (
                  ...
                  >
                    <svg className="w-6 h-6 text-orange-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
